...
![1AtivarRecurso-hyper-v](https://github.com/user-attachments/assets/0e135081-8551-470d-87d6-9e5afc053f3a)

2. Escolher a ISO do sistema operacional
Baixe e selecione a ISO desejada (exemplo: Ubuntu Linux)                                                                                               ![2Escolha_a_ISO](https://github.com/user-attachments/assets/25038c9a-60a1-48b9-887c-28160a44a5d9)

3. Abrir o Gerenciador do Hyper-V
Acesse o Gerenciador do Hyper-V
Clique em: Novo > Máquina Virtual
<img width="1127" height="728" alt="3Criar_maquinaVirtual" src="https://github.com/user-attachments/assets/12c2b524-d6ab-4ca4-80d3-431fb779667a" />

4. Assistente de criação
Na primeira tela, clique em Avançar
<img width="706" height="525" alt="4Avançar" src="https://github.com/user-attachments/assets/2bdc9385-79b8-4924-82c9-e3e8399fe29a" />

5. Nome da máquina virtual
